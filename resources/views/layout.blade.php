...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/png" href="/resources/front/images/favicon.png">
    ...
    <div class="container">
        <div class="menu-content">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/"><img src="/resources/front/images/logo.png" alt=""></a>
            </div>
        ...
        <div class="row">
            <div class="col-md-4">
                <aside class="footer-widget">
                    <div class="about-img"><img src="resources/front/images/footer-logo.png" alt=""></div>
                        ...
                        <div class="carousel-inner" role="listbox">
                            <div class="item active">
                                <div class="single-review">
                                    ...
                                    <div class="author-id">
                                        <img src="resources/front/images/author.png" alt="">
            ...
            <div class="col-md-4">
                <aside class="footer-widget">
                    ...
                    <div class="custom-post">
                        <div>
                            <a href="#"><img src="resources/front/images/footer-img.png" alt=""></a>
                        </div>
                        <div>
