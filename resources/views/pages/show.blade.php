                ...
                <div class="col-md-8">
                    <article class="post">
                        ...
                        <div class="post-content">
							...
							<span
                                class="social-share-title pull-left text-capitalize">By {{$post->getUserName()}} On {{$post->getDate()}}</span>
                    ...
                    <div class="top-comment"><!--top comment-->
                        <img src="{{$post->user->getImage()}}" class="pull-left img-circle" alt="" width="100">
                    ...
                    @if(!$post->comments->isEmpty())
                        dd($post->comments->where('status', 1));
                    @foreach($post->getComments() as $comment)
                    <div class="bottom-comment">

                        <div class="comment-img">
                            <img class="img-circle" src="{{$comment->author->getImage()}}" alt="" width="100">
                        </div>
